...
$ocms[14]='
  ...
  <li class="media">
    <div class="media-left">
      <a href="#">
        <img class="media-object img-thumbnail" src="{AVATAR}" alt="">
      </a>
    </div>
          ...
          <div class="footer-comment">
           ...
           0               
            ...
            <span class="comment-reply">
             [if_canquote][<a href="#messbox" class="reply" onClick="copyText(\'{ONLYNAME}\');"  title="Выделите текст в сообщении {ONLYNAME} и нажмите эту ссылку">Цитировать</a>][/if_canquote]
            </span>
          </div>
    </ul>
<br>
